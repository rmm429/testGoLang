...
func HandleAboutIntent(request alexa.Request) alexa.Response {
	return alexa.NewSimpleResponse("About", "Slick Deals was created by Ricky Mangerie in Philadelphia, Pennsylvania as an unofficial Slick Deals Alexa skill.")
}
...
func RequestFeed(mode string) (FeedResponse, error) {
	...
	queryParams.Set("searcharena", "deals")
